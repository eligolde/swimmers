"""
functions to be imported into the swimmers Flask app
"""
...
def search_the_list(list):
    for item in list:
        if "United States" in item['Country']:
            print(item['Athlete'] + " swam for the United States.")
...
if __name__ == '__main__':
    test_make_ordinal()
    presidents_list = convert_to_dict("swim.csv")
    search_the_list(swim_list)
